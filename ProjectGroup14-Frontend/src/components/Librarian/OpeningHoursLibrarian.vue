<template>
  <div id="OpeningHoursLibrarian">
     ...
     <div style="margin-top:50px">
        <a style="margin-top:50px"><router-link to="/LibrarianMainPage">Back</router-link></a>
     </div>
  </div>
</template>

<script src="./OpeningHoursLibrarian.js">
</script>

<style>
  @import url('https://fonts.googleapis.com/css?family=Varela+Round');

  #OpeningHoursLibrarian {
